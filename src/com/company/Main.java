...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        String menu = """
         ...
         [0] Exit.
         Enter:""";
        ArrayList<TD_item> tasks = new ArrayList<>();
    ...
    public static TD_item update(ArrayList<TD_item> tasks, boolean return_back){
        String s = "\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n";
        String task_title;
        String task_des;
        String task_level;
    ...
    public static void show_list(ArrayList<TD_item> tasks) {
        String tasks_list = "";
        /*for(TD_item a: tasks){
            System.out.println(a);
        }*/
        for (int i = 0; i < tasks.size(); i++) {
            TD_item task_get = tasks.get(i);
            tasks_list = tasks_list + ("(" + (i+1) + ")" + task_get.display()) + "\n";
        }
        System.out.println(tasks_list);
    }
    public static void show_by_pri(ArrayList<TD_item> tasks, String pri){
